...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-4 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="index.html" class="navbar-brand p-0">
            <img class="img-fluid me-3" src="img/icon/Portos_Logo_Ring" alt="Icon">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                <div class="owl-carousel header-carousel">
                    <div class="owl-carousel-item">
                        <img class="img-fluid" src="img/Food n Snack/Porto_s Big Breakfast.jpeg" alt="">
                    </div>
                    <div class="owl-carousel-item">
                        <img class="img-fluid" src="img/Food n Snack/Creamy Ginger Linguine.JPG" alt="">
                    </div>
                    <div class="owl-carousel-item">
                        <img class="img-fluid" src="img/Food n Snack/Nachos.jpg" alt="">
                    </div>
                    <div class="owl-carousel-item">
                        <img class="img-fluid" src="img/Food n Snack/khewnyuk.jpg" alt="">
                    </div>
                    <div class="owl-carousel-item">
                        <img class="img-fluid" src="img/Food n Snack/Kue Lobak.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
